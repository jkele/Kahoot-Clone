...
namespace PRA__Projekt.Controllers.CRUD
{
    public class QuizsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Title,Code,Id,CreatedOn")] Quiz quiz)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Title,Code,Id,CreatedOn")] Quiz quiz)
        {
            if (id != quiz.Id)
            {
                return NotFound();
